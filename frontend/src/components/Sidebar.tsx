...
export function Sidebar({ activeView, setActiveView }: SidebarProps) {
  const navItems = [
    { id: 'upload' as ViewType, label: 'Upload FASTA', icon: 'Upload' },
    { id: 'recent' as ViewType, label: 'Recent Uploads', icon: 'Clock' },
    { id: 'metadata' as ViewType, label: 'Metadata Dashboard', icon: 'BarChart' },
    { id: 'report' as ViewType, label: 'Generate Report', icon: 'FileText' },
  ];
