        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            >
                <motion.div
                    ...
                    className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-purple-200/50 dark:border-purple-700/50"
                >
                    {/* Header with 3D Effect */}
                    <div className="relative p-8 bg-gradient-to-br from-purple-600 to-indigo-700 text-white overflow-hidden">
                        <motion.div
                            animate={{
                        ...
                        >
                            ...
                            <p className="text-purple-100">Sign in to Symbio-NLM</p>
                        </motion.div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-8 space-y-6">
                        ...
                        >
                            ...
                            >
                                ...
                                <input
                                    ...
                                    className="w-full pl-11 pr-4 py-3 bg-gray-50 dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 dark:focus:border-purple-400 transition-all outline-none text-gray-900 dark:text-white"
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-11 pr-12 py-3 bg-gray-50 dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 dark:focus:border-purple-400 transition-all outline-none text-gray-900 dark:text-white"
                                    placeholder="••••••••"
                                    required
                                />
                                <motion.button
                        ...
                        <motion.button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all relative overflow-hidden"
