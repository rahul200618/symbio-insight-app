  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="p-6 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl text-white shadow-lg"
      >
      ...
      {parsedSequences.length > 0 && (
        ...
        >
          <div className="flex items-center gap-2">
            <Icons.CheckCircle className="w-5 h-5 text-blue-600 dark:text-blue-400" />
            <p className="text-sm text-blue-900 dark:text-blue-100">
              Data loaded from parsed sequences: {parsedSequences.length} sequence{parsedSequences.length !== 1 ? 's' : ''} analyzed
            </p>
          </div>
        </motion.div>
      )}
