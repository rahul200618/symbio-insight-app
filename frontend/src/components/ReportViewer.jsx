...
export function ReportViewer({ parsedSequences = [] }: ReportViewerProps) {
  ...
  return (
    <motion.div
      initial={{ opacity, y, y).toLocaleDateString('en-US', {
            month,
            day,
            year,
            hour,
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Sequences
          </div>
          <p className="text-2xl text-gray-900 dark:text-white">{totalSequences}</p>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Total analyzed
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">GC Content
          </div>
          <p className="text-2xl text-gray-900 dark:text-white">{gcPercentage.toFixed(1)}%</p>
          <p className="text-xs text-green-600 dark:text-green-400 mt-1">Optimal range
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">ORFs Found
          </div>
          <p className="text-2xl text-gray-900 dark:text-white">{totalORFs}</p>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Open reading frames
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Total Length
          </div>
          <p className="text-2xl text-gray-900 dark:text-white">{(totalLength / 1000).toFixed(1)}k bp
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Base pairs
        </motion.div>
      </div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-gray-900 dark:text-white">AI-Generated Summary
          <p className="text-sm text-gray-500 dark:text-gray-400">Automated analysis and insights
        </div>
        ...
        <div className="space-y-4">
          <div className="p-4 rounded-lg bg-purple-50/50 dark:bg-purple-900/20 border border-purple-100/50 dark:border-purple-800/50">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-900 dark:text-white mb-1">Sequence Quality Assessment
          ...
          <div className="p-4 rounded-lg bg-indigo-50/50 dark:bg-indigo-900/20 border border-indigo-100/50 dark:border-indigo-800/50">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-900 dark:text-white mb-1">Nucleotide Composition
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="p-4 rounded-lg bg-green-50/50 dark:bg-green-900/20 border border-green-100/50 dark:border-green-800/50">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-900 dark:text-white mb-1">Open Reading Frame Analysis
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="p-4 rounded-lg bg-purple-50/50 dark:bg-purple-900/20 border border-purple-100/50 dark:border-purple-800/50">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-900 dark:text-white mb-1">Recommendations
              <p className="text-sm text-gray-600 dark:text-gray-400">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-gray-900 dark:text-white">Detailed Metrics
          <p className="text-sm text-gray-500 dark:text-gray-400">Complete statistical breakdown
        </div>

        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-3">
            <h4 className="text-sm text-gray-700 dark:text-gray-300 mb-4">Sequence Statistics
            {[
              ...
              <div key={index} className="flex justify-between items-center p-3 rounded-lg bg-gray-50 dark))}
          </div>

          <div className="space-y-3">
            <h4 className="text-sm text-gray-700 dark:text-gray-300 mb-4">Composition Analysis
            {[
