...
export function MetadataCards({ parsedSequences = [] }: MetadataCardsProps) {
  ...
  const atPercentage = stats ? (100 - stats.avgGC)
  ...
  return (
    <div className="space-y-6">
      ...
      {parsedSequences.length > 0 && (
        <div className="p-4 rounded-lg bg-green-50 dark)
              </p>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="p-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Base Pairs
          <p className="text-2xl text-gray-900 dark:text-white">{totalLength.toLocaleString()} bp
        </div>
        ...
        <div className="p-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-300 text-xs rounded-lg">Optimal
          </div>
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">GC Content
        ...
        <div className="p-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Sequences
        ...
        <div className="p-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="px-3 py-1 bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-300 text-xs rounded-lg">Detected
          </div>
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">ORF Detection
          <p className="text-2xl text-gray-900 dark:text-white">{totalORFs} ORFs
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="p-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-gray-900 dark:text-white mb-1">Nucleotide Distribution
              <p className="text-sm text-gray-500 dark:text-gray-400">Base pair composition analysis
            </div>
          ...
          <div className="grid grid-cols-4 gap-3">
            {nucleotideData.map((item) => (
              <div key={item.name} className="p-3 rounded-lg bg-gray-50 dark)}%</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="p-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-gray-900 dark:text-white mb-1">GC Content Analysis
              <p className="text-sm text-gray-500 dark:text-gray-400">Guanine-Cytosine ratio
            </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1 space-y-4">
              {gcData.map((item) => (
                <div key={item.name} className="p-4 rounded-lg bg-purple-50/50 dark,
                        backgroundColor,
                      }}
                    />
                  </div>
      ...
      <div className="p-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-gray-900 dark:text-white">Detailed Sequence Statistics
            <p className="text-sm text-gray-500 dark:text-gray-400">Comprehensive analysis results
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="p-4 rounded-lg bg-purple-50/50 dark:bg-purple-900/20 border border-purple-100/50 dark:border-purple-800/50">
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Average Sequence Length
            <p className="text-xl text-gray-900 dark:text-white">{avgLength} bp
          </div>
          <div className="p-4 rounded-lg bg-indigo-50/50 dark:bg-indigo-900/20 border border-indigo-100/50 dark:border-indigo-800/50">
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Longest Sequence
            <p className="text-xl text-gray-900 dark:text-white">{longestSeq.toLocaleString()} bp
          </div>
          <div className="p-4 rounded-lg bg-purple-50/50 dark:bg-purple-900/20 border border-purple-100/50 dark:border-purple-800/50">
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Shortest Sequence
            <p className="text-xl text-gray-900 dark:text-white">{shortestSeq} bp
          </div>
          <div className="p-4 rounded-lg bg-green-50/50 dark:bg-green-900/20 border border-green-100/50 dark:border-green-800/50">
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">ORFs Detected
          ...
          <div className="p-4 rounded-lg bg-amber-50/50 dark:bg-amber-900/20 border border-amber-100/50 dark:border-amber-800/50">
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Total Sequences
            <p className="text-xl text-gray-900 dark:text-white">{totalSequences}</p>
          </div>
          <div className="p-4 rounded-lg bg-indigo-50/50 dark:bg-indigo-900/20 border border-indigo-100/50 dark:border-indigo-800/50">
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Total Base Pairs
            <p className="text-xl text-gray-900 dark:text-white">{totalLength.toLocaleString()} bp
          </div>
        </div>
      </div>
    </div>
