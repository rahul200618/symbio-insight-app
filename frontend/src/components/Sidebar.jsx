...
export function Sidebar({ activeView, setActiveView }: SidebarProps) {
  ...
  return (
    <div className="w-72 bg-white dark) => {
          const Icon = Icons[item.icon typeof Icons];
      ...
      <div className="p-4 m-4 rounded-lg bg-purple-50/50 dark:bg-purple-900/20 border border-purple-100/50 dark:border-purple-800/50">
        <div className="flex items-center gap-2 mb-2">
          ...
          <div>
            <p className="text-sm text-gray-700 dark:text-gray-300">Storage Used
            <p className="text-xs text-gray-500 dark:text-gray-400">2.4 GB of 50 GB
          </div>
        </div>
